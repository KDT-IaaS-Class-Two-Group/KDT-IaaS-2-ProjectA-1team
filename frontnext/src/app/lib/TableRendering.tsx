...
interface TableRenderingProps {
  data: Data[];
  editData: { [key: number]: Partial<Data> };
  handleEdit: (id: number, field: string, value: any) => void;
  handleKeyPress: (e: React.KeyboardEvent, id: number, field: string) => void;
  inputRefs: React.MutableRefObject<{ [key: number]: HTMLInputElement | null }>;
}

const TableRendering: React.FC<TableRenderingProps> = ({ data, editData, handleEdit, handleKeyPress, inputRefs }) => {
  return (
    <table>
      <thead>
        <tr>
